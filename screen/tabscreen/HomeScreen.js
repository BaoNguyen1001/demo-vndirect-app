...
import { Text, View, FlatList, TouchableOpacity, Animated, Image, StyleSheet } from 'react-native';
        ...
        <View>
            <FlatList
                ...
                renderItem={({ item, index }) => {
                    //let rateColor = (item.rate == 0 ? 'white' : item.rate > 0 ? 'green' : 'red')
                    let rateColor = item.rate >= 0 ? 'green' : 'red';
                    return (
